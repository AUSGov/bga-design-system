...
$(document).ready(function () {
    ...
    evaluatehtmlCode(expr);
});

 //html
 function evaluatehtmlCode(selectedColour) {
    var heroPathwayHtml =
                        ...
                        <div class="action-card-content">
                            <div class="hero-pathway-list-content">
                                <div class="hero-pathway-list-content-left">
                                    <div class="hero-pathway-list-category">
                                        Label
                                    </div>
                                    <h3 class="hero-pathway-list-title">
                                        Hero pathway
                                    </h3>
                                    <div class="hero-pathway-list-secondary-description">
                                        Link to other pages on the site. Hero pathways are a great way to highlight important content.
                                    </div>
                                </div>
...
.hero-pathway-list .action-card-button:active,
.hero-pathway-list .action-card-button:focus,
.hero-pathway-list .action-card-button:hover {
  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);
  cursor: pointer;
  transform: translateY(-4px);
}
.hero-pathway-list .action-card-button:active .action-card-content,
.hero-pathway-list .action-card-button:focus .action-card-content,
...
.hero-pathway-list .action-card-button:hover .hero-pathway-list-title {
  color: #254f90;
  text-decoration: underline;
}
.hero-pathway-list-secondary-description {
  font-weight: 400;
  font-size: 16px;
  line-height: 1.71;
}
...
.hero-pathway-list .action-card-button:focus .circleIcon,
...
@media (max-width: 800px) {
  ...
  .hero-pathway-list .hero-pathway-list-title {
    line-height: 30px;
  }
}
</pre>
