...
`;
  ...
  evaluatePrimaryButtonHtml(""); //SECONDARY BUTTON
...
`;
  ...
  evaluateSecondaryButtonHtml(""); //TERTIARY BUTTON
...
`;
  ...
  evaluateTertiaryButtonHtml(""); //LINK TEXT
...
`;
  ...
  evaluateLinkTextHtml(""); //PAGINATION
  //html
  ...
  $(".pagination-code .html-code code pre").text(paginationHtml); //css
...
`;
  $(".pagination-code .css-code").html(paginationCss); //======================================================= Headers =============================================================================
  //H1
  //html

  var headingOneHtml = `<h1>Lorem ipsum dolor sit amet, consectetur adipiscing</h1>`;
  $(".heading-one-code .html-code code pre").text(headingOneHtml); //css
...
`;
  $(".heading-one-code .css-code").html(headingOneCss); //H2
  //html

  var headingTwoHtml = `<h2>Lorem ipsum dolor sit amet, consectetur adipiscing</h2>`;
  $(".heading-two-code .html-code code pre").text(headingTwoHtml); //css
...
`;
  $(".heading-two-code .css-code").html(headingTwoCss); //H3
  //html

  var headingThreeHtml = `<h3>Lorem ipsum dolor sit amet, consectetur adipiscing</h3>`;
  $(".heading-three-code .html-code code pre").text(headingThreeHtml); //css
...
`;
  $(".heading-three-code .css-code").html(headingThreeCss); //H4
  //html

  var headingFourHtml = `<h4>Lorem ipsum dolor sit amet, consectetur adipiscing</h4>`;
  $(".heading-four-code .html-code code pre").text(headingFourHtml); //css
...
`;
  $(".heading-four-code .css-code").html(headingFourCss); //H5
  //html

  var headingFiveHtml = `<h5>Lorem ipsum dolor sit amet, consectetur adipiscing</h5>`;
  $(".heading-five-code .html-code code pre").text(headingFiveHtml); //css
...
`;
  $(".heading-five-code .css-code").html(headingFiveCss); //Body text
  //html

  var bodyTextHtml = `<p class="body-text">Body text - Lorem ipsum dolor sit amet, consectet adipiscing elit.</p>`;
  $(".body-text-code .html-code code pre").text(bodyTextHtml); //css
...
`;
  $(".body-mini-code .css-code").html(bodyMiniCss); //List
  //html
...
`;
  $(".list-code .html-code code pre").text(listHtml); //css
...
`;
  $(".header-intro-code .css-code").html(headerIntroCss); //Header updated
  //html

  var headerUpdatedHtml = `<p class="header-updated">Updated: 15 March 2019</p>`;
  $(".header-updated-code .html-code code pre").text(headerUpdatedHtml); //css
...
`;
  $(".header-updated-code .css-code").html(headerUpdatedCss); //Header label
  //html

  var headerLabelHtml = `<p class="header-label">Label</p>`;
  $(".header-label-code .html-code code pre").text(headerLabelHtml); //css
...
`;
  $(".header-label-code .css-code").html(headerLabelCss); //======================================================= STANDARD FORM ELEMENTS =============================================================================
  //Text box
  //html
...
`;
  $(".text-box-code .html-code code pre").text(textBoxHtml); //css
...
`;
  $(".text-box-code .css-code").html(textBoxCss); //Text box
  //html
...
`;
  $(".text-area-code .html-code code pre").text(textAreaHtml); //css
...
`;
  $(".text-area-code .css-code").html(textAreaCss); //Units text box
  //html
...
`;
  $(".units-text-box-code .html-code code pre").text(unitsTextBoxHtml); //css
...
`;
  $(".units-text-box-code .css-code").html(unitsTextBoxCss); //Select dropdown
  //html
...
`;
  $(".select-dropdown-code .html-code code pre").text(selectDropdownHtml); //css
...
`;
  $(".select-dropdown-code .css-code").html(selectDropdownCss); //Radio buttons
  //html
...
`;
  $(".radio-buttons-code .html-code code pre").text(radioButtonsHtml); //css
...
`;
  $(".radio-buttons-code .css-code").html(radioButtonsCss); //Radio buttons
  //html
...
`;
  $(".radio-buttons-2-code .html-code code pre").text(radioButtons2Html); //css
...
`;
  $(".radio-buttons-2-code .css-code").html(radioButtons2Css); //Checkbox
  //html
...
`;
  $(".checkbox-code .html-code code pre").text(checkboxHtml); //css
...
`;
  $(".checkbox-code .css-code").html(checkboxCss); //PRIMARY FORM BUTTON
  //html

  var primaryFormButtonHtml = `
<a class="primary-button" href="#">Primary</a>
`;
  $(".primary-form-button-code .html-code code pre").text(primaryFormButtonHtml); //css
...
`;
  $(".secondary-form-button-code .html-code code pre").text(secondaryFormButtonHtml); //css
...
`;
  $(".secondary-form-button-code .css-code").html(secondaryFormButtonCss); //Button group
  //html
...
`;
  $(".button-group-code .html-code code pre").text(buttonGroupHtml); //css
...
`;
  $(".button-group-code .css-code").html(buttonGroupCss); //Add field
  //html
...
`;
  $(".add-field-code .html-code code pre").text(addFieldHtml); //css
...
`;
  $(".add-field-code .css-code").html(addFieldCss); //Primary text button field
  //html
...
`;
  $(".primary-text-button-field-code .html-code code pre").text(primaryTextButtonFieldHtml); //css
...
`;
  $(".primary-text-button-field-code .css-code").html(primaryTextButtonFieldCss); //Secondary text button field
  //html
...
`;
  $(".secondary-text-button-field-code .html-code code pre").text(secondaryTextButtonFieldHtml); //css
...
`;
  $(".secondary-text-button-field-code .css-code").html(secondaryTextButtonFieldCss); //Text box with help
  //html
...
`;
  $(".text-box-inline-help-simple-code .html-code code pre").text(textBoxInlineHelpSimpleHtml); //css
...
`;
  $(".text-box-inline-help-simple-code .css-code").html(textBoxInlineHelpSimpleCss); //Text box with help complex
  //html
...
`;
  $(".text-box-inline-help-complex-code .html-code code pre").text(textBoxInlineHelpComplexHtml); //css
...
`;
  $(".text-box-inline-help-complex-code .css-code").html(textBoxInlineHelpComplexCss); //Warning Notification
  //html
...
`;
  $(".form-warning-notification-code .html-code code pre").text(formWarningNotificationHtml); //css
