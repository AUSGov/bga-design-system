                    ...
                    <div class="action-card-content">
                        <div class="hero-pathway-list-content">
                            <div class="hero-pathway-list-content-left">
                                <div class="hero-pathway-list-category">Label</div>
                                <h3 class="hero-pathway-list-title">Hero pathway</h3>
                                <div class="hero-pathway-list-secondary-description">Link to other pages on the site. Hero pathways are a great way to highlight important content.</div>
                            </div>
...
`<div class="standard-pathway-list">
    <a class="standard-pathway-anchor" href="#">
        <div class="standard-pathway-card">
...
.standard-pathway-card:hover h3 {
  color: #254f90;
  text-decoration: underline;
}
...
/* Outer svg */
.standard-pathway-card .action-card-info .circleIcon {
  position: absolute;
  bottom: 0;
  box-sizing: content-box;
  display: none;
...
.standard-pathway-card:focus .action-card-info .circleIcon,
.standard-pathway-card:hover .action-card-info .circleIcon {
  display: inline;
}
.standard-pathway-card .action-card-info .circleIcon svg {
  fill: none;
}
.standard-pathway-card .action-card-info .circleIcon-inner svg,
.standard-pathway-card:focus .action-card-info .circleIcon svg,
.standard-pathway-card:hover .action-card-info .circleIcon svg {
  fill: #4569a0;
}
/* inner svg */
.standard-pathway-card .action-card-info .circleIcon-inner {
  top: 0;
  height: 16px;
  width: 16px;
  display: inline-block;
...
.standard-pathway-card:hover .action-card-info .circleIcon-inner svg {
  fill: #fff;
}
</pre>
</code>
...
`<div class="light-pathway-list">
  <a class="light-pathway-anchor" href="www.google.com">
    <div class="light-pathway-card">
...
.light-pathway-card .action-card-info .circleIcon-inner {
  top: 0;
  height: 16px;
  width: 16px;
  display: inline-block;
